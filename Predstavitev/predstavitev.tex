...
\begin{frame}{$\mu(P_n)$ za $n > 3$}
	Najprej oštevilčimo povezave kot $e_1, e_2, \ldots, e_{n-1}$, kjer $e_i = v_i v_{i+1}$ za $1 \le i < n$. \pause
...
\begin{frame}{$\mu(C_n)$ za $n = 4k + 3$}
	V tem primeru moramo prav tako popravit uteži na dveh povezavah. Deluje kar isti popravek kot v prejšnjem primeru.
		...
		\draw[] (6) to node [text=green,above] {$\{2,3\}$}  (1);
		\end{tikzpicture}
...
\begin{frame}{Literatura}
	 ...
	 \bibliography{literatura_pred.bib}
\end{frame}
