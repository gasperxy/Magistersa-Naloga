...
Dodatno se izkaže, da veliko zgornjih mej za kromatično število velja tudi za seznamsko verzijo. Konkretno reformulacija Brooks-ovega izreka velja tudi za seznamsko barvanje. To pomeni, da v kolikor $G$ ni poln graf ali lih cikler velja $ch(G) \le \Delta(G)$. Vendar to še ne pomeni, da sta si $\chi(G)$ in $ch(G)$ blizu. Obstajajo preprosti grafi, kjer je razlika med parametroma lahko poljubna. Klasični primeri tega so polni dvodelni grafi $K_{m,n}$.
...
Ta razdelek najdemo v članku ~\cite{regular}. V tem članku sta 2 glavna rezultata in sicer 1-2-3-4 utežitev za d-regularne grafe, kar je narejeno na algoritmičen način. Drugi rezultat pa je,
