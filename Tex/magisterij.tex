...
Večina tega razdelka je povzeta po ~\cite{examples}. Primere sem predelal in jih mislim da precej jasno razložil. V članku so rezultati napisani precej
...
\end{cases} .
 $$
 To pa ja pravilno barvanje $K_n$ in zato $\mu(K_n) = $.
 ...
 \subsubsection{3-obarljivi grafi}
  V ~\cite{base}  sta ... zastavila vprašanje, ki je nato pripeljalo do 1-2-3 domneve in ga v njem tudi dokazala za primer 3-obarljivih grafov.
  \begin{trditev}
...
Posledica te trditve je, da za 3-barljive grafe 1-2-3 domneva drži. Dejansko pa pove še to, če za graf obstaja $k$ barvanje, potem obstaja tudi $k$-utežitev za to barvanje.
\begin{proof}
	content...
\end{proof}

\begin{posledica}
	Če je $G$ $3$-barljiv graf, potem je $\mu(G) \le 3$.
\end{posledica}
